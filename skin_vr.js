...
function pano2vrVrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		texture = loader.load('data:image/png;base64,');
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	''+
	''+
	'');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	't3E3nPRT8+ssKCCjNUobSY0iwhFBdSnGkR5UWUZ5ukhQVamLHIn59Vlh28ELm5Z5VvZnZSfII9zXSy+4z17hN9wXRam/n3AK3NCwAAAAAAAAAAAODZH5HtSU2EeOt2AAAAAElFTkSuQmCC');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	'XoGxV9exUZ642Jp6IvNW7kekXOXjHOqNG3VfSdtBl/rm1h6hFuEf3i/15yh7ydl9xRMd5zL7nPNTltChsw+YSZ5hT41EHGa/lM+1ab0bawDV7moDHk6UFj2MXiFjm9HDQ8Kj/NeT1HZUmSJEmSJEmSJEmSJEmSJEmSJEnvwD0H+MjnG3D6FgAAAABJRU5ErkJggg==');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
	...
	function SkinHotspotClass_ht_video_url(parentScope,hotspot) {
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	''+
	'KQWCVAP/LwmitAIlNDHwOhKBqkHdZK+D6hJhnNXUVm3QxMCrwLd/DTyBqq7fs2ECVXjCU/COGDRM4twYVJHyTuKse0wpaY36NOB1ouSiQcg6myQy05tEacAAL8wsnzRg8ETy4wi1IKnSZwHSqCjHVxH8ZRbHcRzHcRzHcRzHGTb+An7GUxmB7G9EAAAAAElFTkSuQmCC');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
	...
	'AAAABJRU5ErkJggg==');
		...
		textureOver = loader.load('data:image/png;base64,'+
	'AAAABJRU5ErkJggg==');
	...
	function SkinHotspotClass_ht_info(parentScope,hotspot) {
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	''+
	''+
	''+
	'suzbe4vGTh1pk7Rb9mmejrmmkS0N6yQtkf1udW6MjR5JhyX9IOlHSd8ZY/rLeU+DSgK0R1LcWKJd0i5Ju40x7THHldNpkDRLtlo1ylazbtn1uIFcfm6J7UL7xyjiHcAbwEJynGEfHGxu8RkvMG9jv0P9/walFGA2sJgafBxXUFBQUFBQUBCQfwFADYF823rNFAAAAABJRU5ErkJggg==');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
	...
	function SkinHotspotClass_ht_image(parentScope,hotspot) {
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	''+
	''+
	'');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		loader = new THREE.TextureLoader();
		texture = loader.load('data:image/png;base64,'+
	''+
	''+
	''+
	''+
	'');
		texture.colorSpace = player.getVRTextureColorSpace();
		material = new THREE.MeshBasicMaterial( {map: texture, side: THREE.DoubleSide, transparent: true} );
